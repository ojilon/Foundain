package com.Foundain.shared.activities;
...
import com.Foundain.shared.activity.media.AppCompatActivityUtils;
import com.Foundain.shared.data.DataUtils;
import com.Foundain.shared.file.FileUtils;
import com.Foundain.shared.file.filesystem.FileType;
...
import com.Foundain.shared.interact.ShareUtils;
import com.Foundain.shared.models.ReportInfo;
import com.Foundain.shared.theme.NightMode;
 ...
 * {@code `<activity android:name="com.Foundain.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.Foundain.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
